        ...
        <Header />
          <div className='container'>
            <div className="col-md-4">
              ...
              <h5 className="card-title text-uppercase fw-bold">Name: {randomBeer.name}</h5>
              <p className="card-text">Tagline: {randomBeer.tagline}</p>
              ...
              <p className="card-text">Description: {randomBeer.description}</p>
